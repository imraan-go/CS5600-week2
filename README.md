...
### Question 3
 ...
 python3 scheduler.py -p RR -l 100,200,300 -q 1 -c
ARG policy RR
ARG jlist 100,200,300
...
### Question 6
 ...
 scheduler.py -p SJF -l 200,200,300 -q 1 -c
ARG policy SJF
ARG jlist 200,200,300
...
Execution trace:
  [ time   0 ] Run job 0 for 200.00 secs ( DONE at 200.00 )
  [ time 200 ] Run job 1 for 200.00 secs ( DONE at 400.00 )
  [ time 400 ] Run job 2 for 300.00 secs ( DONE at 700.00 )

Final statistics:
  Job   0 -- Response: 0.00  Turnaround 200.00  Wait 0.00
  Job   1 -- Response: 200.00  Turnaround 400.00  Wait 200.00
  Job   2 -- Response: 400.00  Turnaround 700.00  Wait 400.00

  Average -- Response: 200.00  Turnaround 433.33  Wait 200.00


python3 scheduler.py -p SJF -l 200,300,300 -q 1 -c
ARG policy SJF
ARG jlist 200,300,300
...
Execution trace:
  ...
  [ time 500 ] Run job 2 for 300.00 secs ( DONE at 800.00 )
...
Final statistics:
  ...
  Average -- Response: 233.33  Turnaround 500.00  Wait 233.33


scheduler.py -p SJF -l 200,300,400 -q 1 -c
ARG policy SJF
...
As the job length increases, Average response time increases.
### Question 7

Response time increases linearly with quantum length increase. Let N be the number of jobs and q the quantum length, then the worst-case response time is (N-1)q/N.